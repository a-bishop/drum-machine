...
import './beat-row.js';
import './arp-row.js';
import { notes } from './notes.js'; // notes of scale represent # of intervals from tonic
...
class DrumMachine extends LitElement {
  ...
  constructor() {
    ...
    this.activeBeat = 'beatIndex0'; // Bass setup
    ...
    }, [null, null, null, null, null, null, null, null], '8n').start(); // Snare setup
    ...
    }, [null, null, null, null, null, null, null, null], "8n").start(); // hiHat setup
    ...
    var autoFilter = new Tone.AutoFilter({
      ...
      "min": 800,
      "max": 15000
    }).connect(Tone.Master); //connect the noise

    hiHat.connect(autoFilter); //start the autofilter LFO

    autoFilter.start(); // Arpeggiator Setup
